...
echo 'runcmd:
  - [ cloud-init-per, boot, grow_VG, pvresize, /dev/xvda2 ]
  - [ cloud-init-per, boot, grow_LV, lvresize, -l, +100%FREE, /dev/centos/root ]
  - [ cloud-init-per, boot, grow_FS, resize2fs, /dev/system/root ]' > /etc/cloud/cloud.cfg.d/51_extend_volume.cfg
